...
export default function StatCard({ value, label, variant = 'default' }: StatCardProps) {
  const variants = {
    danger: {
      container: "p-6 bg-red-900/30 border border-red-700/50 rounded-lg hover:border-red-400 hover:bg-red-900/40 transition-all duration-300 text-center group hover:scale-105 hover:-translate-y-1",
    ...
    info: {
      container: "p-6 bg-blue-900/30 border border-blue-700/50 rounded-lg hover:border-blue-400 hover:bg-blue-900/40 transition-all duration-300 text-center group hover:scale-105 hover:-translate-y-1",
    ...
    success: {
      container: "p-6 bg-green-900/30 border border-green-700/50 rounded-lg hover:border-green-400 hover:bg-green-900/40 transition-all duration-300 text-center group hover:scale-105 hover:-translate-y-1",
    ...
    default: {
      container: "p-6 bg-slate-800 border border-slate-700 rounded-lg hover:border-slate-500 transition-all duration-300 text-center group hover:scale-105 hover:-translate-y-1",
